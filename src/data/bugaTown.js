export const BUGA_TOWN_PROPERTIES = [
  { id: 'cake-street', neighborhood: 'שכונת המתוקים', name: 'רחוב העוגה', emoji: '🎂', price: 60, rent: 12, question: 'אם קונים נכס ב-60 מטבעות ונשארים עם 140, כמה היו לפני הקנייה?', answer: '200', options: ['200', '180', '120', '60'] },
  { id: 'balloon-park', neighborhood: 'שכונת המתוקים', name: 'פארק הבלונים', emoji: '🎈', price: 70, rent: 14, question: 'איזה דבר חשוב יותר לפני קנייה במשחק: לבדוק שיש מספיק מטבעות או לקנות מיד?', answer: 'לבדוק שיש מספיק מטבעות', options: ['לבדוק שיש מספיק מטבעות', 'לקנות מיד', 'לדלג על התור', 'לזרוק שוב'] },
  { id: 'riddle-library', neighborhood: 'שכונת הידע', name: 'ספריית החידות', emoji: '📚', price: 80, rent: 16, question: 'מה עוזר לפתור חידה: לקרוא את כל המשפט או לנחש אחרי המילה הראשונה?', answer: 'לקרוא את כל המשפט', options: ['לקרוא את כל המשפט', 'לנחש אחרי המילה הראשונה', 'להתעלם מהרמז', 'לשאול את הקובייה'] },
  { id: 'dice-square', neighborhood: 'שכונת הידע', name: 'כיכר הקוביות', emoji: '🎲', price: 90, rent: 18, question: 'בקובייה רגילה, מה המספר הכי גבוה שאפשר לקבל?', answer: '6', options: ['6', '5', '8', '10'] },
  { id: 'trivia-tower', neighborhood: 'שכונת הידע', name: 'מגדל הטריוויה', emoji: '🧠', price: 100, rent: 20, question: 'מה עדיף בטריוויה: תשובה מדויקת או תשובה מצחיקה אבל שגויה?', answer: 'תשובה מדויקת', options: ['תשובה מדויקת', 'תשובה מצחיקה אבל שגויה', 'לא לענות', 'להחליף שאלה בלי לקרוא'] },
  { id: 'music-studio', neighborhood: 'שכונת היצירה', name: 'אולפן המוזיקה', emoji: '🎵', price: 110, rent: 22, question: 'מה מודד קצב במוזיקה?', answer: 'מהירות הפעימות', options: ['מהירות הפעימות', 'צבע הצליל', 'שם הזמר', 'אורך הכבל'] },
  { id: 'space-gate', neighborhood: 'שכונת ההרפתקה', name: 'שער החלל', emoji: '🚀', price: 120, rent: 24, question: 'איזה כוכב לכת קרוב יותר לשמש: כדור הארץ או מאדים?', answer: 'כדור הארץ', options: ['כדור הארץ', 'מאדים', 'שניהם באותו מרחק', 'הירח'] },
  { id: 'team-hall', neighborhood: 'שכונת ההרפתקה', name: 'אולם הקבוצות', emoji: '🤝', price: 130, rent: 26, question: 'מה עוזר לקבוצה לנצח: שיתוף פעולה או שכל אחד מסתיר מידע?', answer: 'שיתוף פעולה', options: ['שיתוף פעולה', 'להסתיר מידע', 'לא להקשיב', 'לשחק לבד'] },
]
