export const BUGA_TOWN_PROPERTIES = [
  { id: 'cake-street', name: 'רחוב העוגה', emoji: '🎂', price: 60, rent: 12, question: 'אם קונים נכס ב-60 מטבעות ונשארים עם 140, כמה היו לפני הקנייה?', answer: '200', options: ['200', '180', '120', '60'] },
