...
const PREM = ['אתר משלכם לשימוש גם מחוץ לבוגה: בביו באינסטגרם, בוואטסאפ ובכל מקום', 'דף נחיתה מרשים ומותאם אישית, שבונים בקלות הכי גדולה', 'גלריות תמונות ולינקים לסרטונים', 'חבילות, שירותים ומחירים', 'דירוג וביקורות מגוגל, מתעדכנים לבד', 'המלצות מלקוחות', 'כל מה שיש בחינם', 'נראות גבוהה יותר באתר']
