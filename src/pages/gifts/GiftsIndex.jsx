...
export default function GiftsIndex() {
  ...
  const presets = {
    ...
    '/gifts/under-50': { title: 'מתנות עד 50 ₪', desc: 'רעיונות קטנים ומשמחים בתקציב נגיש, לפי גיל.' },
    '/gifts/under-100': { title: 'מתנות עד 100 ₪', desc: 'רעיונות שימושיים ומהנים עד 100 ₪, לפי גיל.' },
