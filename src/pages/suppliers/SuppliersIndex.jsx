...
export default function SuppliersIndex() {
  ...
  return <div className="mx-auto max-w-6xl px-4 py-8">
    ...
    <section className="wobbly mt-10 border-2 border-[var(--border)] bg-[var(--postit)] p-6 text-center sm:p-8">
      ...
      <p className="mx-auto mt-2 max-w-xl text-lg">🎁 בתקופת ההשקה כרטיס ספק בעוגה בוגה הוא בחינם: לוגו, תמונה, קצת עליכם ורשתות חברתיות — ופניות ישירות אליכם לוואטסאפ. תראו בדיוק כמה פניות הגיעו מאיתנו.</p>
      <Link to="/suppliers/me" className="mt-5 inline-block rounded-2xl bg-[var(--ink)] px-6 py-3 text-lg font-bold text-white">הצטרפות בחינם, לזמן מוגבל ←</Link>
    </section>
  </div>
}
