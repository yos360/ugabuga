...
const WHO = [
  ...
  ['🎩', 'לספקים', 'כרטיס ספק בחינם, עם פניות ישירות לוואטסאפ — ורואים בדיוק כמה פניות הגיעו מאיתנו. רוצים יותר? ⭐ פרימיום בוגה: דף נחיתה מעוצב עם גלריה, סרטונים וביקורות.'],
]
...
export default function About() {
  return <div className="mx-auto max-w-5xl px-4 py-8">
    ...
    <section className="mx-auto mt-10 grid max-w-4xl grid-cols-1 items-center gap-6 sm:grid-cols-[minmax(0,1fr)_260px]">
      ...
      <img src="/images/home-birthday-girl.png" alt="" className="mx-auto w-52 sm:w-full" loading="lazy" />
    </section>
